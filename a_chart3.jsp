...
<head>
<title>Purchased Products Type</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p>&nbsp;</p>
          <p align="center" class="style2">View Purchased Products  Category Type</p>
		  <p align="center" class="style7">&nbsp;</p>
          <p align="center"><iframe align="middle" width="600" height="500" src="graph3.jsp"></iframe></p>		  
		  

		  
		<p>&nbsp;</p>
		<p align="right" class="style6"><a href="a_main.jsp" class="style6">Back</a></p>  
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
