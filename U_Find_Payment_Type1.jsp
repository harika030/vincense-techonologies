...
<head>
<title>U_Find_Payment_Type</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3" style="color:#FF0033">Found Payment Type !!! </h2>
          ...
          <table width="310" height="92" border="3" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr bgcolor="#99FF33">
					<td  width="302" height="36" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6 style11 style10">Found Payment  Type Results Type </div></td>
...
try 
{
 ...
 String Product_Purchase=request.getParameter("Product_Purchase");
 String amount=request.getParameter("amount");	
 String nameOrig=request.getParameter("nameOrig");	
 String oldbalanceOrg=request.getParameter("oldbalanceOrg");
 String newbalanceOrig=request.getParameter("newbalanceOrig");	
 String nameDest=request.getParameter("nameDest");	
